...
const HeroSection = () => {
  ...
  return (
    <section className="w-full h-screen bg-gradient-to-r from-blue-50 to-white relative flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Hero Content */}
      <motion.div
        className="flex flex-col md:flex-row items-center justify-center w-full max-w-7xl px-6 md:px-12 mt-16 md:mt-0 pt-12"
      ...
      >
        ...
        <div className="text-center md:text-left w-full md:w-1/2 space-y-6 md:space-y-8 mb-10 md:mb-0 relative z-10">
          ...
          <motion.p
            className="text-xl sm:text-2xl text-gray-600 max-w-2xl mx-auto md:mx-0"
            initial={{ opacity: 0 }}
          ...
          <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-6 pt-2 justify-center md:justify-start">
            <motion.button
              className="bg-blue-600 text-white px-8 py-3 rounded-full text-lg md:text-xl font-semibold hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 shadow-lg"
            ...
            <motion.button
              className="bg-white text-blue-600 border-2 border-blue-600 px-6 py-3 rounded-full text-lg md:text-xl font-semibold hover:bg-blue-50 transition-all duration-300"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Learn more
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center relative">
          <div className="relative w-64 h-64 sm:w-72 sm:h-72 md:w-96 md:h-96">
            ...
            <div className="absolute w-[15%] h-[15%] bg-blue-200 rounded-full top-[5%] left-[5%] z-20"></div>
            <div className="absolute w-[10%] h-[10%] bg-purple-200 rounded-full bottom-[5%] right-[5%] z-20"></div>
            <div className="absolute w-[8%] h-[8%] bg-blue-300 rounded-full top-[2%] right-[2%] z-20"></div>
            <div className="absolute w-[6%] h-[6%] bg-purple-300 rounded-full bottom-[2%] left-[2%] z-20"></div>
            
            {/* Main image (center) */}
            <div className="absolute top-4 left-4 right-4 bottom-4 flex items-center justify-center z-10">
